...
def main():
    ...
    for j in range(n_points):
        ...
        mean_r_squared.append(np.mean(r2_values))
    ...
    # Plot
    plt.plot(time, mean_r_squared, ls='', marker='o', ms=2 ,label=r"$\langle r^2(t) \rangle$")
    plt.xlabel("Time (s)")
    plt.ylabel("Mean squared displacement (pixels²)")
    plt.legend()
    plt.show()
